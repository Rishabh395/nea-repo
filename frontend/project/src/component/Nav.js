    ...
    <div>
     <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
      { auth ?
        ...
        <Link to='/' className="navbar-brand" href="#">FARE-JRARE</Link>
          <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
            <span className="navbar-toggler-icon" />
          </button>
          <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div className="navbar-nav">
               <Link to='/welcome' className="nav-link navbar-brand " aria-current="page" href="#">HOUSE-RENT</Link>
               <Link to='/welcome' className="nav-link navbar-brand" href="#">CAR-PARK</Link>
               <Link to='/welcome' className="nav-link navbar-brand" href="#">POST</Link>
             ...
             <Link to='/register'onClick={logout}  className="nav-link  navbar-brand bg-danger " href="#">LOGOUT</Link>
              ...
              <div className='log'>
              <Link to='/' className="nav-link navbar-brand" href="#">FARE-JRARE</Link>
